            ...
            <div className="flex flex-row px-4 py-4">
                ...
                <div className="w-2/3 px-2">
                    ...
                    <div className="flex flex-row">
                        <div className="pr-4"><div className="p-4 h-full w-full bg-background rounded-2xl border-2 border-action-primary hover:border-white-main"><a className="flex flex-col items-center" target="_blank" href="https://github.com/DrBig-Brain"><img className="p-2 invert h-1/2 w-1/2" src="https://simpleicons.org/icons/github.svg"></img><p className="text-action-primary text-xl">Github</p></a></div></div>
                        <div className="px-4"><div className="p-4 h-full w-full bg-background rounded-2xl border-2 border-action-primary hover:border-white-main"><a className="flex flex-col items-center" target="_blank" href="https://www.linkedin.com/in/abhinavmishra05/"><img className="p-2 invert h-1/2 w-1/2" src="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/linkedin-square-icon.svg"></img><p className="text-action-primary text-xl">Linkedin</p></a></div></div>
                        <div className="px-4"><div className="p-4 h-full w-full bg-background rounded-2xl border-2 border-action-primary hover:border-white-main"><a className="flex flex-col items-center" target="_blank" href="https://huggingface.co/DrBig-Brain"><img className="p-2 invert h-1/2 w-1/2" src="https://simpleicons.org/icons/huggingface.svg"></img><p className="text-action-primary text-xl">Huggingface</p></a></div></div>
                        <div className="px-4"><div className="p-4 h-full w-full bg-background rounded-2xl border-2 border-action-primary hover:border-white-main"><a className="flex flex-col items-center" target="_blank" href="https://www.kaggle.com/abhinav10101010"><img className="p-2 invert h-1/2 w-1/2" src="https://simpleicons.org/icons/kaggle.svg"></img><p className="text-action-primary text-xl">Kaggle</p></a></div></div>
                        <div className="pl-4"><div className="p-4 h-full w-full bg-background rounded-2xl border-2 border-action-primary hover:border-white-main"><a className="flex flex-col items-center" target="_blank" href="https://leetcode.com/problemset/"><img className="p-2 invert h-1/2 w-1/2" src="https://simpleicons.org/icons/leetcode.svg"></img><p className="text-action-primary text-xl">Leetcode</p></a></div></div>
                    </div>
                </div>
            </div>
